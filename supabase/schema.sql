...
begin
  ...
  insert into task_catalog(family_id, key, category, name, icon, points, needs_approval, family_required, weekdays) values
    ...
    (fam.id, 'wakeup', 'RESPONSIBILITY', 'Wake up on time', '⏰', 5, false, false, '{0,1,2,3,4,5,6}'),
    (fam.id, 'makebed', 'RESPONSIBILITY', 'Make your bed', '🛌', 5, false, false, '{0,1,2,3,4,5,6}'),
    (fam.id, 'brush_morning', 'RESPONSIBILITY', 'Brush teeth (morning)', '🦷', 5, false, false, '{0,1,2,3,4,5,6}'),
    (fam.id, 'breakfast', 'RESPONSIBILITY', 'Eat breakfast', '🍳', 5, false, false, '{0,1,2,3,4,5,6}'),
    (fam.id, 'lunch', 'RESPONSIBILITY', 'Eat lunch', '🍽️', 5, false, false, '{0,1,2,3,4,5,6}'),
    (fam.id, 'dinner', 'RESPONSIBILITY', 'Eat dinner', '🍲', 5, false, false, '{0,1,2,3,4,5,6}'),
    (fam.id, 'shower_night', 'RESPONSIBILITY', 'Shower before bed', '🚿', 5, false, false, '{0,1,2,3,4,5,6}'),
    (fam.id, 'brush_night', 'RESPONSIBILITY', 'Brush teeth (before bed)', '🦷', 5, false, false, '{0,1,2,3,4,5,6}'),
